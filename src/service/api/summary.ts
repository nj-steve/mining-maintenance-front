...
// /api/repair_statistics/countries
/*
 * 获取国家故障机占比统计数据
 * @param params - 统计参数
 * @param params.start_date - 开始日期，格式：YYYY-MM-DD
 ...
 * @param params.dimension - 统计维度：`site`（场地）或 `station`（网点）
 */
export function fetchCountryStatistics(dimension: 'site' | 'station',start_date: string,end_date: string) {
  return request({
    url: '/api/repair_statistics/countries',
    method: 'get',
    params: {
      dimension,
      start_date,
...
// /api/repair_statistics/heat_diss_modes
/*
 * 获取散热模式故障占比统计数据
 * @param params - 统计参数
 * @param params.start_date - 开始日期，格式：YYYY-MM-DD
 ...
 * @param params.dimension - 统计维度：`site`（场地）或 `station`（网点）
 */
export function fetchHeatDissModeStatistics(dimension: 'site' | 'station',start_date: string,end_date: string) {
  return request({
    url: '/api/repair_statistics/heat_diss_modes',
    method: 'get',
    params: {
      dimension,
      start_date,
